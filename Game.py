...
class OutException(IngameException):
    def __str__(self):
        return "Вы стреляете за пределами поля боя!"


class UsedException(IngameException):
    def __str__(self):
        return "Вы уже стреляли в это место!"


class WrongShipException(IngameException):
    pass
